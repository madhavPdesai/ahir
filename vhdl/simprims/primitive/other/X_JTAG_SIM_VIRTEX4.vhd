...
--  /   /         
-- /___/   /\     Filename : X_JTAG_SIM_VIRTEX4.vhd
...
entity X_JTAG_SIM_VIRTEX4_SUBMOD is
...
end X_JTAG_SIM_VIRTEX4_SUBMOD;

architecture X_JTAG_SIM_VIRTEX4_SUBMOD_V OF X_JTAG_SIM_VIRTEX4_SUBMOD is
...
--####################################################################
  ...
  begin
      VitalSetupHoldCheck (
        ...
        RefTransition        => 'R',
        HeaderMsg            => "/X_X_JTAG_SIM_VIRTEX4",
        Xon                  => Xon,
        MsgOn                => MsgOn,
        MsgSeverity          => warning);
...
end X_JTAG_SIM_VIRTEX4_SUBMOD_V;


----- CELL X_JTAG_SIM_VIRTEX4  -----
...
architecture X_JTAG_SIM_VIRTEX4_V OF X_JTAG_SIM_VIRTEX4 is

  component X_JTAG_SIM_VIRTEX4_SUBMOD
     generic(
         PART_NAME : string;
         IRLength  : integer
         );
...
--####################################################################
  G1: if((PART_NAME   = "LX15") or (PART_NAME = "lx15") or
        ...
        JTAG_INST : X_JTAG_SIM_VIRTEX4_SUBMOD
          generic map (
            PART_NAME => PART_NAME,
            IRLength  => 10
          )
