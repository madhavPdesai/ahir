-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/X_RAMS64_ADV.vhd,v 1.3 2010/01/14 19:38:17 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_RAMS64_ADV is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMS64_ADV : entity is true;
end X_RAMS64_ADV;

architecture X_RAMS64_ADV_V of X_RAMS64_ADV is
  attribute VITAL_LEVEL0 of
    X_RAMS64_ADV_V : architecture is true;
...
begin
  ...
  VITALReadBehavior  : process(ADR0_dly, ADR1_dly, ADR2_dly, ADR3_dly, ADR4_dly, ADR5_dly, MEM)
    variable Index   : integer := 64 ;
    variable Address : std_logic_vector( 5 downto 0) ;
  begin
    Address                    := (ADR5_dly, ADR4_dly, ADR3_dly, ADR2_dly, ADR1_dly, ADR0_dly);
  ...
  VITALTimingCheck                  : process (CLK_dly, I_dly, ADR0_dly, ADR1_dly, ADR2_dly, ADR3_dly, ADR4_dly, WE_dly, WE1_dly, WE2_dly)
  ...
  begin
    ...
    VitalPathDelay01 (
      ...
      OutSignalName => "O",
      OutTemp       => O_zd,
      Paths         => (0 => (CLK_dly'last_event, tpd_CLK_O, (we_all /= '0')),
