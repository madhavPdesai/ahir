...
-- /___/   /\     Filename : X_RAMB4_S4_S4.vhd
...
entity X_RAMB4_S4_S4 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB4_S4_S4 : entity is true;
end x_ramb4_s4_s4;

architecture X_RAMB4_S4_S4_V of X_RAMB4_S4_S4 is
  attribute VITAL_LEVEL0 of
    X_RAMB4_S4_S4_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable DOA_zd            : std_logic_vector(3 downto 0) := (others => '0');
    variable DOB_OV_LSB        : integer;
    variable DOB_OV_MSB        : integer;
    variable DOB_zd            : std_logic_vector(3 downto 0) := (others => '0');
                ...
                if ((collision_type = 1) or (collision_type = 3)) then                
                   Memory_Collision_Msg
                     (collision_type => Write_A_Write_B,                     
                      EntityName => "X_RAMB4_S4_S4",
                      InstanceName => x_ramb4_s4_s4'path_name,
