...
--  /   /         
-- /___/   /\     Filename : X_JTAG_SIM_VIRTEX5.vhd
...
entity X_JTAG_SIM_VIRTEX5_SUBMOD is
...
end X_JTAG_SIM_VIRTEX5_SUBMOD;

architecture X_JTAG_SIM_VIRTEX5_SUBMOD_V OF X_JTAG_SIM_VIRTEX5_SUBMOD is
...
--####################################################################
  ...
  begin
      VitalSetupHoldCheck (
        ...
        RefTransition        => 'R',
        HeaderMsg            => "/X_X_JTAG_SIM_VIRTEX5",
        Xon                  => Xon,
        MsgOn                => MsgOn,
        MsgSeverity          => warning);
...
end X_JTAG_SIM_VIRTEX5_SUBMOD_V;


----- CELL X_JTAG_SIM_VIRTEX5  -----
...
architecture X_JTAG_SIM_VIRTEX5_V OF X_JTAG_SIM_VIRTEX5 is

  component X_JTAG_SIM_VIRTEX5_SUBMOD
     generic(
         PART_NAME : string;
         IRLength  : integer
         );
...
--####################################################################
  G1: if((PART_NAME  = "FX30T")	 or (PART_NAME   = "fx30t")  or
	...
	(PART_NAME   = "TX240T") or (PART_NAME   = "tx240t")) generate
        ...
        JTAG_INST : X_JTAG_SIM_VIRTEX5_SUBMOD
          generic map (
            PART_NAME => PART_NAME,
            IRLength  => 10
          )
