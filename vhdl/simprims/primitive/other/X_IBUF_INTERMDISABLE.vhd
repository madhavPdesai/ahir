...
--  /   /                  Input Buffer
-- /___/   /\     Filename : X_IBUF_INTERMDISABLE.vhd
...
entity X_IBUF_INTERMDISABLE is
  ...
  attribute VITAL_LEVEL0 of
    X_IBUF_INTERMDISABLE : entity is true;

end X_IBUF_INTERMDISABLE;

architecture X_IBUF_INTERMDISABLE_V of X_IBUF_INTERMDISABLE is

  attribute VITAL_LEVEL0 of
    X_IBUF_INTERMDISABLE_V : architecture is true;
...
--  
  ...
  begin 
     ...
     wait on I_ipd, IBUFDISABLE_ipd, INTERMDISABLE_ipd;
  end process;


end X_IBUF_INTERMDISABLE_V;
