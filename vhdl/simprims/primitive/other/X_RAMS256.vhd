-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/X_RAMS256.vhd,v 1.3 2010/01/14 19:38:17 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_RAMS256 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMS256 : entity is true;
end X_RAMS256;

architecture X_RAMS256_V of X_RAMS256 is
  attribute VITAL_LEVEL0 of
    X_RAMS256_V : architecture is true;
  ...
  signal MEM : std_logic_vector( 256 downto 0 ) :=  ('X' & To_StdLogicVector(INIT) );
begin
  WireDelay  : block
  begin
  ...
  begin
    ...
    VitalSignalDelay (ADR7_dly, ADR7_ipd, tisd_ADR7_CLK);
  ...
  ReadBehavior  : process(ADR0_dly, ADR1_dly, ADR2_dly, ADR3_dly, ADR4_dly, ADR5_dly, 
                          ADR6_dly, ADR7_dly, MEM)
    variable Index   : integer := 256 ;
    variable Address : std_logic_vector( 7 downto 0) ;
  begin
    Address                    := (ADR7_dly, ADR6_dly, ADR5_dly, ADR4_dly, ADR3_dly, ADR2_dly, ADR1_dly, ADR0_dly);
  ...
  VITALTimingCheck  : process(ADR0_dly, ADR1_dly, ADR2_dly, ADR3_dly, ADR4_dly, ADR5_dly, ADR6_dly, ADR7_dly, CLK_dly, I_dly, WE_dly)
    ...
    variable Tviol_ADR7_CLK_posedge : std_ulogic := '0';
    ...
    variable Tmkr_ADR7_CLK_posedge : VitalTimingDataType := VitalTimingDataInit;
  ...
  begin
    if (TimingChecksOn ) then
      ...
      VitalSetupHoldCheck (
        ...
        MsgSeverity    => warning);
      VitalSetupHoldCheck (
        Violation      => Tviol_ADR7_CLK_posedge,
        TimingData     => Tmkr_ADR7_CLK_posedge,
        TestSignal     => ADR7_dly,
        TestSignalName => "ADR7",
        TestDelay      => tisd_ADR7_CLK,
        RefSignal      => CLK_dly,
        RefSignalName  => "CLK",
        RefDelay       => ticd_CLK,
        SetupHigh      => tsetup_ADR7_CLK_posedge_posedge,
        SetupLow       => tsetup_ADR7_CLK_negedge_posedge,
        HoldLow        => thold_ADR7_CLK_posedge_posedge,
        HoldHigh       => thold_ADR7_CLK_negedge_posedge,
        CheckEnabled   => TO_X01(WE_dly) /= '0',
        RefTransition  => 'R',
        HeaderMsg      => "/X_RAMS256",
        Xon            => Xon,
    ...
    Violation         <= Tviol_I_CLK_posedge or Tviol_WE_CLK_posedge or
                         ...
                         Tviol_ADR6_CLK_posedge or Tviol_ADR7_CLK_posedge or Pviol_CLK;
  ...
  begin
    ...
    VitalPathDelay01 (
      ...
      Paths         => (0 => (CLK_dly'last_event, tpd_CLK_O, (WE_dly /= '0')),
                        ...
                        8   => (ADR7_dly'last_event, tpd_ADR7_O, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
