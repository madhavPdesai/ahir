...
-- /___/   /\     Filename : X_RAMB4_S1_S2.vhd
...
entity X_RAMB4_S1_S2 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB4_S1_S2 : entity is true;
end x_ramb4_s1_s2;

architecture X_RAMB4_S1_S2_V of X_RAMB4_S1_S2 is
  attribute VITAL_LEVEL0 of
    X_RAMB4_S1_S2_V : architecture is true;
                ...
                if ((collision_type = 1) or (collision_type = 3)) then                
                   Memory_Collision_Msg
                     (collision_type => Write_A_Write_B,                     
                      EntityName => "X_RAMB4_S1_S2",
                      InstanceName => x_ramb4_s1_s2'path_name,
