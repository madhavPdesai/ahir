...
end X_JTAG_SIME2_SUBMOD;

architecture X_JTAG_SIME2_SUBMOD_V OF X_JTAG_SIME2_SUBMOD is
...
architecture X_JTAG_SIME2_V OF X_JTAG_SIME2 is

  component X_JTAG_SIME2_SUBMOD
     generic(
         PART_NAME : string;
         IRLength  : integer
         );
...
------------------------------------------------
  ...
  begin
       if((PartName = "LX40") OR (PartName = "LX20") OR (PartName = "LX10")) then
           return 6;
       elsif((PartName = "LX80") OR (PartName = "LX70") OR (PartName = "LX60")) then
           return 12;
       elsif((PartName = "LX120") OR (PartName = "LX100") OR (PartName = "LX90")) then
           return 18;
       elsif((PartName = "LX1200") OR (PartName = "LX1000") OR (PartName = "LX900")) then
           return 24;
       else
           return 0;
       end if;
