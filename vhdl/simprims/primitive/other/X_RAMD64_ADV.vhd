-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/X_RAMD64_ADV.vhd,v 1.5 2011/10/03 20:01:09 yanx Exp $
-------------------------------------------------------------------------------
...
--    10/03/11 - Add WADR4 and WADR5 to timing check list (CR627465) 
-- End Revision
...
--    variable Violation  : std_ulogic := '0';
  ...
  VITALTimingCheck                   : process (CLK_dly, I_dly, WADR0_dly, WADR1_dly, WADR2_dly, WADR3_dly, WADR4_dly, WADR5_dly, WE_dly, WE1_dly, WE2_dly)
