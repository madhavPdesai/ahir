...
--  /   /                  Input Buffer
-- /___/   /\     Filename : X_IBUF_INTERMDISABLE_TPWRGT.vhd
...
entity X_IBUF_INTERMDISABLE_TPWRGT is
  ...
  attribute VITAL_LEVEL0 of
    X_IBUF_INTERMDISABLE_TPWRGT : entity is true;

end X_IBUF_INTERMDISABLE_TPWRGT;

architecture X_IBUF_INTERMDISABLE_TPWRGT_V of X_IBUF_INTERMDISABLE_TPWRGT is

  attribute VITAL_LEVEL0 of
    X_IBUF_INTERMDISABLE_TPWRGT_V : architecture is true;
...
--  
  ...
  begin 
     ...
     wait on I_ipd, IBUFDISABLE_ipd, INTERMDISABLE_ipd, TPWRGT_ipd;
  end process;


end X_IBUF_INTERMDISABLE_TPWRGT_V;
