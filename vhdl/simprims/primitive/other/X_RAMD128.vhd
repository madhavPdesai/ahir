-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/X_RAMD128.vhd,v 1.3 2010/01/14 19:38:17 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_RAMD128 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMD128 : entity is true;
end X_RAMD128;

architecture X_RAMD128_V of X_RAMD128 is
  attribute VITAL_LEVEL0 of
    X_RAMD128_V : architecture is true;
...
begin
  ...
  begin
    ...
    VitalWireDelay (RADR6_ipd, RADR6, tipd_RADR6);
    ...
    VitalWireDelay (WADR6_ipd, WADR6, tipd_WADR6);
  ...
  begin
    ...
    VitalSignalDelay (WADR6_dly, WADR6_ipd, tisd_WADR6_CLK);
    VitalSignalDelay (WE_dly, WE_ipd, tisd_WE_CLK);
  end block;

  ReadBehavior  : process(RADR6_ipd, RADR5_ipd, RADR4_ipd, RADR3_ipd, RADR2_ipd, RADR1_ipd, RADR0_ipd, MEM)
    variable Index   : integer := 128;
    variable Address : std_logic_vector( 6 downto 0) ;
  begin
    Address := (RADR6_ipd, RADR5_ipd, RADR4_ipd, RADR3_ipd, RADR2_ipd, RADR1_ipd, RADR0_ipd);
  ...
  WriteBehavior    : process(CLK_dly, Violation)
    variable wr_address : std_logic_vector( 6 downto 0);
    variable index_wr   : integer    := 128;
  begin
    if (rising_edge(CLK_dly)) then
      if (WE_dly = '1') then
        wr_address := (WADR6_dly, WADR5_dly, WADR4_dly, WADR3_dly, WADR2_dly, WADR1_dly, WADR0_dly);
  ...
  VITALTimingCheck                   : process (CLK_dly, I_dly, WADR0_dly, WADR1_dly, WADR2_dly, WADR3_dly, WADR4_dly, WADR5_dly, WADR6_dly, WE_dly)
    ...
    variable Tviol_WADR6_CLK_posedge : std_ulogic := '0';
    ...
    variable Tmkr_WADR6_CLK_posedge : VitalTimingDataType := VitalTimingDataInit;
  ...
  begin
    if (TimingChecksOn ) then
      ...
      VitalSetupHoldCheck (
        ...
        MsgSeverity    => warning);
      VitalSetupHoldCheck (
        Violation      => Tviol_WADR6_CLK_posedge,
        TimingData     => Tmkr_WADR6_CLK_posedge,
        TestSignal     => WADR6_dly,
        TestSignalName => "WADR6",
        TestDelay      => tisd_WADR6_CLK,
        RefSignal      => CLK_dly,
        RefSignalName  => "CLK",
        RefDelay       => ticd_CLK,
        SetupHigh      => tsetup_WADR6_CLK_posedge_posedge,
        SetupLow       => tsetup_WADR6_CLK_negedge_posedge,
        HoldLow        => thold_WADR6_CLK_posedge_posedge,
        HoldHigh       => thold_WADR6_CLK_negedge_posedge,
        CheckEnabled   => TO_X01(WE_dly) /= '0',
        RefTransition  => 'R',
        HeaderMsg      => "/X_RAMD128",
        Xon            => Xon,
  ...
  begin
    ...
    VitalPathDelay01 (
      ...
      OutSignalName => "O",
      OutTemp       => O_zd,
      Paths         => (0 => (CLK_dly'last_event, tpd_CLK_O, (WE_dly /= '0') and (RADR0_ipd = WADR0_dly and RADR1_ipd = WADR1_dly and RADR2_ipd = WADR2_dly and RADR3_ipd = WADR3_dly and RADR4_ipd = WADR4_dly and RADR5_ipd = WADR5_dly and RADR6_ipd = WADR6_dly)),
                        ...
                        7   => (RADR6_ipd'last_event, tpd_RADR6_O, true)),
      Mode          => VitalTransport,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
