...
--  /   /         
-- /___/   /\     Filename : X_JTAG_SIM_VIRTEX6.vhd
-- \   \  /  \    Timestamp : Thu May  6 16:04:38 PDT 2010
--  \___\/\___\
--
-- Revision:
...
architecture X_JTAG_SIM_VIRTEX6_V OF X_JTAG_SIM_VIRTEX6 is
...
--####################################################################
  ...
  begin
      VitalSetupHoldCheck (
        ...
        RefTransition        => 'R',
        HeaderMsg            => "/X_X_JTAG_SIM_VIRTEX6",
        Xon                  => Xon,
        MsgOn                => MsgOn,
        MsgSeverity          => warning);
