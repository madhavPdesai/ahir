...
-- /___/   /\     Filename : X_RAMB4_S2_S2.vhd
...
entity X_RAMB4_S2_S2 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB4_S2_S2 : entity is true;
end x_ramb4_s2_s2;

architecture X_RAMB4_S2_S2_V of X_RAMB4_S2_S2 is
  attribute VITAL_LEVEL0 of
    X_RAMB4_S2_S2_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable DOA_zd            : std_logic_vector(1 downto 0) := (others => '0');
    variable DOB_OV_LSB        : integer;
    variable DOB_OV_MSB        : integer;
    variable DOB_zd            : std_logic_vector(1 downto 0) := (others => '0');
                ...
                if ((collision_type = 1) or (collision_type = 3)) then                
                   Memory_Collision_Msg
                     (collision_type => Write_A_Write_B,                     
                      EntityName => "X_RAMB4_S2_S2",
                      InstanceName => x_ramb4_s2_s2'path_name,
