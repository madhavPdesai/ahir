...
--  /   /                  Input Buffer
-- /___/   /\     Filename : X_IBUF_IBUFDISABLE.vhd
...
entity X_IBUF_IBUFDISABLE is
  ...
  attribute VITAL_LEVEL0 of
    X_IBUF_IBUFDISABLE : entity is true;

end X_IBUF_IBUFDISABLE;

architecture X_IBUF_IBUFDISABLE_V of X_IBUF_IBUFDISABLE is

  attribute VITAL_LEVEL0 of
    X_IBUF_IBUFDISABLE_V : architecture is true;
...
--  
  ...
  begin 
     ...
     wait on I_ipd, IBUFDISABLE_ipd;
  end process;


end X_IBUF_IBUFDISABLE_V;
