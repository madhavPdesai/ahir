-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/X_BUFGMUX_1.vhd,v 1.6 2010/01/14 19:43:22 fphillip Exp $
-------------------------------------------------------------------------------
...
--    02/19/09 - Add intial to q0_t and q1_t (CR507901)
--    05/11/09 - Add period check (CR521102)
--    11/23/09 - Change Q to 1 instead of H (CR538513)
-- End Revision
...
begin
  ...
  Q_zd <= I0_dly when (q0_t = '1') else I1_dly when (q1_t = '1') else 'X' when (q0_t = 'X' or q1_t = 'X') else '1';
  ...
  begin
    ...
    (
      ...
      PulseWidthLow  => 0 ps,
      CheckEnabled   => TRUE,
      HeaderMsg      => InstancePath & "/X_BUFGMUX_1",
      Xon            => Xon,
      MsgOn          => MsgOn,
      MsgSeverity    => WARNING
    );
