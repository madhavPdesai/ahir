-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/X_SRLC16E.vhd,v 1.3 2010/01/14 19:43:23 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_SRLC16E is
  ...
  attribute VITAL_LEVEL0 of
    X_SRLC16E : entity is true;
end X_SRLC16E;

architecture X_SRLC16E_V of X_SRLC16E is
  attribute VITAL_LEVEL0 of
    X_SRLC16E_V : architecture is true;
...
begin
  ...
  VITALTiming                     : process (CLK_dly, CE_dly, D_dly, Q_zd, Q15_zd)
  ...
  VITALPathDelay            : process (Q_zd, Q15_zd, Violation)
    variable Q_zdt          : std_ulogic := '0';
    variable Q15_zdt        : std_ulogic := '0';
  ...
  begin
    ...
    VitalPathDelay01 (
      ...
      OutSignalName => "Q15",
      OutTemp       => Q15_zdt,
      Paths         => (0 => (CLK_dly'last_event, tpd_CLK_Q15, (CE_dly /= '0'))),
      Mode          => VitalInertial,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
