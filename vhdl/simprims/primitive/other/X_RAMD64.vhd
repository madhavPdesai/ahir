-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/X_RAMD64.vhd,v 1.4 2010/01/14 19:43:23 fphillip Exp $
-------------------------------------------------------------------------------
...
-- /___/   /\     Filename : X_RAMD64.vhd
-- \   \  /  \    Timestamp : Thu Apr  8 10:57:19 PDT 2004
--  \___\/\___\
--
-- Revision:
--    03/23/04 - Initial version.
--    02/05/09 - Add WADR4_dly WADR5_dly to timing check block signal list (CR457308)
...
entity X_RAMD64 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMD64 : entity is true;
end X_RAMD64;

architecture X_RAMD64_V of X_RAMD64 is
  attribute VITAL_LEVEL0 of
    X_RAMD64_V : architecture is true;
...
--    variable Violation  : std_ulogic := '0';
  ...
  VITALTimingCheck                   : process (CLK_dly, I_dly, WADR0_dly, WADR1_dly, WADR2_dly, WADR3_dly, WADR4_dly, WADR5_dly, WE_dly)
  ...
  begin
    ...
    VitalPathDelay01 (
      ...
      OutSignalName => "O",
      OutTemp       => O_zd,
      Paths         => (0 => (CLK_dly'last_event, tpd_CLK_O, (WE_dly /= '0') and (RADR0_ipd = WADR0_dly and RADR1_ipd = WADR1_dly and RADR2_ipd = WADR2_dly and RADR3_ipd = WADR3_dly and RADR4_ipd = WADR4_dly and RADR5_ipd = WADR5_dly )),
