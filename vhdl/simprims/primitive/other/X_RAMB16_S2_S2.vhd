...
-- /___/   /\     Filename : X_RAMB16_S2_S2.vhd
...
entity X_RAMB16_S2_S2 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB16_S2_S2 : entity is true;
end x_ramb16_s2_s2;

architecture X_RAMB16_S2_S2_V of X_RAMB16_S2_S2 is

  attribute VITAL_LEVEL0 of
    X_RAMB16_S2_S2_V : architecture is true;
                  ...
                  if (wea_dly_sampled /= '0') then
                    ...
                    if ((collision_type = 1) or (collision_type = 3)) then
                      Memory_Collision_Msg
                        (collision_type => Write_A_Write_B,
                         EntityName => "X_RAMB16_S2_S2",
                         InstanceName => x_ramb16_s2_s2'path_name,
                         address_a => addra_dly_sampled,
                         address_b => addrb_dly_sampled
                         );
                    end if;
