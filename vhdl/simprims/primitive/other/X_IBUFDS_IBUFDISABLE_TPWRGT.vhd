...
-- /___/   /\     Filename : X_IBUFDS_IBUFDISABLE_TPWRGT.vhd
...
entity X_IBUFDS_IBUFDISABLE_TPWRGT is
 ...
 attribute VITAL_LEVEL0 of
    X_IBUFDS_IBUFDISABLE_TPWRGT : entity is true;

end X_IBUFDS_IBUFDISABLE_TPWRGT;

architecture X_IBUFDS_IBUFDISABLE_TPWRGT_V of X_IBUFDS_IBUFDISABLE_TPWRGT is

 attribute VITAL_LEVEL0 of
    X_IBUFDS_IBUFDISABLE_TPWRGT_V : architecture is true;
...
--  end process;
  ...
  begin
     ...
     wait on I_ipd, IB_ipd, IBUFDISABLE_ipd, TPWRGT_ipd;
  end process;

end X_IBUFDS_IBUFDISABLE_TPWRGT_V;
