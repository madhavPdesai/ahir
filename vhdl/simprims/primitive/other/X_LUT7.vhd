-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/X_LUT7.vhd,v 1.3 2010/01/14 19:43:23 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_LUT7 is
  ...
  attribute VITAL_LEVEL0 of
    X_LUT7 : entity is true;
end X_LUT7;

architecture X_LUT7_V of X_LUT7 is
  attribute VITAL_LEVEL1 of
    X_LUT7_V : architecture is true;
...
begin
  ...
  VITALBehavior           : process (ADR0_ipd, ADR1_ipd, ADR2_ipd, ADR3_ipd, ADR4_ipd, ADR5_ipd, ADR6_ipd)
    variable O_zd         : std_ulogic;
    variable O_GlitchData : VitalGlitchDataType;
  begin
    O_zd := VitalMUX(data => To_StdLogicVector(INIT), dselect => (ADR6_ipd, ADR5_ipd, ADR4_ipd, ADR3_ipd, ADR2_ipd, ADR1_ipd, ADR0_ipd));
