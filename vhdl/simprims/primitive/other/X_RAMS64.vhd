-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/X_RAMS64.vhd,v 1.3 2010/01/14 19:43:23 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_RAMS64 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMS64 : entity is true;
end X_RAMS64;

architecture X_RAMS64_V of X_RAMS64 is
  attribute VITAL_LEVEL0 of
    X_RAMS64_V : architecture is true;
...
begin
  ...
  VITALTimingCheck                  : process (CLK_dly, I_dly, ADR0_dly, ADR1_dly, ADR2_dly, ADR3_dly, ADR4_dly, WE_dly)
