...
-- /___/   /\     Filename : X_IOBUFDS_DCIEN.vhd
...
entity X_IOBUFDS_DCIEN is
  generic(
    ...
    tpd_T_IOB : VitalDelayType01 := (0.000 ns, 0.000 ns);
    PATHPULSE : time := 0 ps
    );
  ...
  attribute VITAL_LEVEL0 of
    X_IOBUFDS_DCIEN : entity is true;

end X_IOBUFDS_DCIEN;

architecture X_IOBUFDS_DCIEN_V of X_IOBUFDS_DCIEN is

  attribute VITAL_LEVEL0 of
    X_IOBUFDS_DCIEN_V : architecture is true;
    ...
    if ((T_ipd = '1') or (T_ipd = 'H')) then
     ...
     VitalPathDelay01 (
       ...
       Paths         => (0 => (DCITERMDISABLE_ipd'last_event, tpd_DCITERMDISABLE_O, true),
                         ...
                         5 => (T_ipd'last_event,              tpd_T_O,              true)),
       Mode          => VitalTransport,
       Xon           => Xon,
       MsgOn         => MsgOn,
       MsgSeverity   => warning);
     ...
     VitalPathDelay01 (
       ...
       Paths         => (0 => (DCITERMDISABLE_ipd'last_event, tpd_DCITERMDISABLE_IOB, true),
                         ...
                         3 => (T_ipd'last_event,              tpd_T_IOB,              true)),
       Mode          => VitalTransport,
       Xon           => Xon,
       MsgOn         => MsgOn,
       MsgSeverity   => warning);
     ...
     wait on DCITERMDISABLE_ipd, I_ipd, IBUFDISABLE_ipd, IO_ipd, IOB_ipd, T_ipd;
  end process;

end X_IOBUFDS_DCIEN_V;
