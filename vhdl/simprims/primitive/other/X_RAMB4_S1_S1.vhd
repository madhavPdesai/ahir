...
-- /___/   /\     Filename : X_RAMB4_S1_S1.vhd
...
entity X_RAMB4_S1_S1 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB4_S1_S1 : entity is true;
end x_ramb4_s1_s1;

architecture X_RAMB4_S1_S1_V of X_RAMB4_S1_S1 is
  attribute VITAL_LEVEL0 of
    X_RAMB4_S1_S1_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable DOB_zd            : std_logic_vector(0 downto 0) := (others => '0');
                ...
                if ((collision_type = 1) or (collision_type = 3)) then                
                   Memory_Collision_Msg
                     (collision_type => Write_A_Write_B,                     
                      EntityName => "X_RAMB4_S1_S1",
                      InstanceName => x_ramb4_s1_s1'path_name,
