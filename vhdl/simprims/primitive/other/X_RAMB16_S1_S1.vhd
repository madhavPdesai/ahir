...
-- /___/   /\     Filename : X_RAMB16_S1_S1.vhd
...
entity X_RAMB16_S1_S1 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB16_S1_S1 : entity is true;
end x_ramb16_s1_s1;

architecture X_RAMB16_S1_S1_V of X_RAMB16_S1_S1 is

  attribute VITAL_LEVEL0 of
    X_RAMB16_S1_S1_V : architecture is true;
  ...
  signal ADDRB_ipd : std_logic_vector(13 downto 0)  := (others => 'X');
  ...
  signal ADDRB_dly    : std_logic_vector(13 downto 0)  := (others => 'X');
  signal CLKB_dly     : std_ulogic                    := 'X';
  signal DIB_dly      : std_logic_vector(0 downto 0) := (others => 'X');
  ...
  constant length_b : integer := 16384;  
  constant width_a : integer := 1;
  constant width_b : integer := 1;  
...
begin
  ...
  begin
    ...
    DIB_DELAY   : for i in 0 downto 0 generate
  ...
  VITALBehavior                        : process
    ...
    variable INIT_B_reg         : std_logic_vector (0 downto 0) := "0";
    variable ADDRA_dly_sampled : std_logic_vector(13 downto 0)   := (others => 'X');
    variable ADDRB_dly_sampled : std_logic_vector(13 downto 0)   := (others => 'X');
    ...
    variable DOB_zd            : std_logic_vector(0 downto 0);
    ...
    variable SRVAL_B_reg            : std_logic_vector (0 downto 0) := "0";
  ...
  begin
    if (FIRST_TIME) then
      ...
      if (INIT_B'length > 1) then
        INIT_B_reg(0 downto 0)        := To_StdLogicVector(INIT_B)(0 downto 0);
      else
        INIT_B_reg(INIT_B'length-1 downto 0)         := To_StdLogicVector(INIT_B);
      end if;
      DOB_zd(0 downto 0)                       := INIT_B_reg(0 downto 0);
      DOB  <= DOB_zd;
      ...
      if (SRVAL_B'length > 1) then
        SRVAL_B_reg(0 downto 0)        := To_StdLogicVector(SRVAL_B)(0 downto 0);
      else
                  ...
                  if (wea_dly_sampled /= '0') then
                    ...
                    if ((collision_type = 1) or (collision_type = 3)) then
                      Memory_Collision_Msg
                        (collision_type => Write_A_Write_B,
                         EntityName => "X_RAMB16_S1_S1",
                         InstanceName => x_ramb16_s1_s1'path_name,
                         address_a => addra_dly_sampled,
                         address_b => addrb_dly_sampled
                         );
                    end if;
