-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/X_RAMB4_S4.vhd,v 1.3 2010/01/14 19:43:23 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_RAMB4_S4 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB4_S4 :     entity is true;
end X_RAMB4_S4;

architecture X_RAMB4_S4_V of X_RAMB4_S4 is
  attribute VITAL_LEVEL0 of
    X_RAMB4_S4_V : architecture is true;
...
begin
  ...
  VITALBehavior : process
    ...
    variable DO_zd          : std_logic_vector(3 downto 0)    := (others => '0');
