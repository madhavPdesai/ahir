...
--  /   /         
-- /___/   /\     Filename : X_JTAG_SIM_SPARTAN6.vhd
...
architecture X_JTAG_SIM_SPARTAN6_V OF X_JTAG_SIM_SPARTAN6 is
...
--####################################################################
  ...
  begin
      VitalSetupHoldCheck (
        ...
        RefTransition        => 'R',
        HeaderMsg            => "/X_X_JTAG_SIM_SPARTAN6",
        Xon                  => Xon,
        MsgOn                => MsgOn,
        MsgSeverity          => warning);
