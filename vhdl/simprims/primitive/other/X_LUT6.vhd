-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/X_LUT6.vhd,v 1.3 2010/01/14 19:43:23 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_LUT6 is
  ...
  attribute VITAL_LEVEL0 of
    X_LUT6 : entity is true;
end X_LUT6;

architecture X_LUT6_V of X_LUT6 is
...
begin
  ...
  X_LUT6P   : process (ADR0_ipd, ADR1_ipd, ADR2_ipd, ADR3_ipd, ADR4_ipd, ADR5_ipd)
    variable I_reg : std_logic_vector(5 downto 0);
  begin

    I_reg := TO_STDLOGICVECTOR(ADR5_ipd & ADR4_ipd & ADR3_ipd &  ADR2_ipd & ADR1_ipd & ADR0_ipd);

    if ((ADR5_ipd xor ADR4_ipd xor ADR3_ipd xor ADR2_ipd xor ADR1_ipd xor ADR0_ipd) = '1' 
       or (ADR5_ipd xor ADR4_ipd xor ADR3_ipd xor ADR2_ipd xor ADR1_ipd xor ADR0_ipd) = '0') then
  ...
  VITALTIING           : process (ADR0_ipd, ADR1_ipd, ADR2_ipd, ADR3_ipd, ADR4_ipd, ADR5_ipd, O_zd)
