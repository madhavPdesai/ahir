-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/simprim/VITAL/X_RAMS16.vhd,v 1.3 2010/01/14 19:43:23 fphillip Exp $
-------------------------------------------------------------------------------
...
entity X_RAMS16 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMS16 : entity is true;
end X_RAMS16;

architecture X_RAMS16_V of X_RAMS16 is
  attribute VITAL_LEVEL0 of
    X_RAMS16_V : architecture is true;
...
begin
  ...
  VITALReadBehavior  : process(ADR0_dly, ADR1_dly, ADR2_dly, ADR3_dly, MEM)
    variable Index   : integer := 16 ;
    variable Address : std_logic_vector( 3 downto 0) ;
  begin
    Address                    := (ADR3_dly, ADR2_dly, ADR1_dly, ADR0_dly);
  ...
  VITALTimingCheck                  : process (CLK_dly, I_dly, ADR0_dly, ADR1_dly, ADR2_dly, ADR3_dly, WE_dly)
