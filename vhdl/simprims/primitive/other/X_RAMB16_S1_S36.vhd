...
-- /___/   /\     Filename : X_RAMB16_S1_S36.vhd
...
entity X_RAMB16_S1_S36 is
  ...
  attribute VITAL_LEVEL0 of
    X_RAMB16_S1_S36 : entity is true;
end x_ramb16_s1_s36;

architecture X_RAMB16_S1_S36_V of X_RAMB16_S1_S36 is

  attribute VITAL_LEVEL0 of
    X_RAMB16_S1_S36_V : architecture is true;
                  ...
                  if (wea_dly_sampled /= '0') then
                    ...
                    if ((collision_type = 1) or (collision_type = 3)) then
                      Memory_Collision_Msg
                        (collision_type => Write_A_Write_B,
                         EntityName => "X_RAMB16_S1_S36",
                         InstanceName => x_ramb16_s1_s36'path_name,
                         address_a => addra_dly_sampled,
                         address_b => addrb_dly_sampled
                         );
                    end if;
