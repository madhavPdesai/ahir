-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/simprims/rainier/VITAL/X_FIFO18_36.vhd,v 1.5 2010/01/14 19:38:16 fphillip Exp $
-------------------------------------------------------------------------------
...
port (
  ...
  attribute VITAL_LEVEL0 of
     X_FIFO18_36 : entity is true;

end X_FIFO18_36;
                                                                        
architecture X_FIFO18_36_V of X_FIFO18_36 is

  attribute VITAL_LEVEL0 of
    X_FIFO18_36_V : architecture is true;
  ...
  signal OPEN_8 : std_logic_vector(7 downto 0);
    ...
    constant MSB_MAX_RDCOUNT : integer    := 8;
    constant MSB_MAX_WRCOUNT : integer    := 8;
...
X_FIFO18_36_inst : X_AFIFO36_INTERNAL
  generic map (
  ...
  port map (
    ...
    EMPTY => empty_zd,
    FULL => full_zd,
    RDCOUNT(8 downto 0) => rdcount_zd,
    RDCOUNT(12 downto 9) => OPEN_4,
    WRCOUNT(8 downto 0) => wrcount_zd,
...
--  Setup/Hold Check Violations (all input pins)
     ...
     VitalSetupHoldCheck
       (
         ...
         RefTransition  => 'R',
         HeaderMsg      => InstancePath & "/X_FIFO18_36",
         Xon            => Xon,
         MsgOn          => MsgOn,
         MsgSeverity    => Warning
       );
