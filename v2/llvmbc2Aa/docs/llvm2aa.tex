...
\item {\bf llvmpasses} : {\bf llvm2aa} uses the LLVM compiler
...
\item The LLVM switch instruction is currently not supported,
but support is planned in the near future.
...
not supported.  Support for these is planned.
