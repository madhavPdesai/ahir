...
# vc2vhdl -C -s modelsim -T io_module -f prog.opt.o.linked.aa.vc | vhdlFormat > prog_opt_o_linked_aa_vc.vhdl
# comment next line if you are using modelsim
 vc2vhdl -C -s ghdl -T io_module -f prog.opt.o.linked.aa.vc | vhdlFormat > prog_opt_o_linked_aa_vc.vhdl
