...
that was written to it\footnote{    
Note that a read from a signal will block until the
signal has been written into at least once!}.
\end{itemize}
...
\item The \$split operation:  Suppose you want
