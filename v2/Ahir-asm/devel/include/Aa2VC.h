...
void Write_VC_Pipe_Declaration(string name, int width,int depth, bool lifo_mode, bool port_flag, bool in_flag, bool out_flag, bool signal_flag, bool p2p_flag, ostream& ofile);
