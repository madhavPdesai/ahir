...
#line 4207 "vcParser.cpp"
		wid=vc_Identifier();
#line 1051 "vc.g"
		data = dp->Find_Wire(wid); 
		NOT_FOUND__("data",addr,wid,st_id);              
		
#line 4213 "vcParser.cpp"
		match(RPAREN);
#line 1054 "vc.g"
