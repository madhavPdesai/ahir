...
#   note the RUN define.
gcc -DRUN -o dgemm dgemm.c
#
# to generate VHDL
# first use clang (or llvm-gcc) to generate llvm-byte-code
clang -std=gnu89 -emit-llvm -c dgemm.c
#
# lets not optimize
#
...
llvm2aa dgemm.o | vcFormat > dgemm.o.aa
#
...
#
Aa2VC -O dgemm.o.aa | vcFormat > dgemm.o.aa.vc
#
# finally, generate vhdl from the vc description.
#
vc2vhdl -t main -f dgemm.o.aa.vc | vhdlFormat > dgemm_o_aa_vc.vhdl
#
