...
aA_Module
	:	(	FOREIGN 
		...
		MODULE aA_Label aA_In_Args aA_Out_Args 
		(	IS LBRACE ( aA_Object_Declaration )* aA_Atomic_Statement_Sequence RBRACE 
		|	
		) 
	;
...
aA_Series_Block_Statement
	:	SERIESBLOCK 
		...
		LBRACE ( aA_Object_Declaration )* aA_Atomic_Statement_Sequence RBRACE 
	;
...
aA_Fork_Block_Statement
	:	FORKBLOCK 
		...
		LBRACE ( aA_Object_Declaration )* aA_Fork_Block_Statement_Sequence RBRACE 
	;
...
aA_Branch_Block_Statement
	:	BRANCHBLOCK 
		...
		LBRACE ( aA_Object_Declaration )* aA_Branch_Block_Statement_Sequence RBRACE 
	;
...
aA_Join_Fork_Statement
	:	JOIN ( SIMPLE_IDENTIFIER )* 
		(	FORK aA_Atomic_Statement_Sequence 
		|	
		) 
		ENDJOIN 
	;
