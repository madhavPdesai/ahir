...
void getData()
{
char buffer[1024];  char* ss;  sprintf(buffer, "call getData ");
...
void sendResult()
{
char buffer[1024];  char* ss;  sprintf(buffer, "call sendResult ");
append_int(buffer,0); ADD_SPACE__(buffer);
append_int(buffer,0); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
return;
...
void vectorSum()
{
char buffer[1024];  char* ss;  sprintf(buffer, "call vectorSum ");
append_int(buffer,0); ADD_SPACE__(buffer);
append_int(buffer,0); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
return;
...
void x_vectorSum_()
{
char buffer[1024];  char* ss;  sprintf(buffer, "call x_vectorSum_ ");
append_int(buffer,0); ADD_SPACE__(buffer);
append_int(buffer,0); ADD_SPACE__(buffer);
send_packet_and_wait_for_response(buffer,strlen(buffer)+1,"localhost",9999);
return;
