...
\Aa file.
\begin{verbatim}
llvm2aa [-modules=<listfile>] bytecode.o > bytecode.aa
\end{verbatim}
...
-modules=listfile
\end{verbatim}
can be used to specify the list of functions in the bytecode
which should be converted to \Aa.  If absent, all functions
are converted.
...
to a \vC description. 
\begin{verbatim}
Aa2VC [-O] [-I obj-name] file1.aa file2.aa ...  > result.vc
\end{verbatim}
