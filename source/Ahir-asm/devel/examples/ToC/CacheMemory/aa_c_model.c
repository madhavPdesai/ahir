...
cachememory_State* cachememory_(cachememory_State* __top)
{
...
__top->init._if_line_10309976_entry = 1;
}
// -------------------------------------------------------------------------------------------
// Begin Statement _if_line_10309976
// -------------------------------------------------------------------------------------------
if (__top->init._if_line_10309976_entry)
{
if (1) {
if (__LESS((__top->init.I).__val, 3 )) { 
__top->init._if_line_10309976_entry = 0;
__top->init._if_line_10309976_in_progress = 1;
__top->init._assign_line_43_entry = 1;
} 
else {
__top->init._if_line_10309976_entry = 0;
__top->init._if_line_10309976_in_progress = 0;
__top->init._if_line_10309976_exit = 1;
} // transfer control based on test condition
} // proceed if pipe is available 
} // entry flag
if (__top->init._if_line_10309976_in_progress) {
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
// End Statement _if_line_10309976
// -------------------------------------------------------------------------------------------
	if (__top->init._if_line_10309976_exit) {
__top->init._merge_line_38_exit = 0;
__top->init._assign_line_39_exit = 0;
__top->init._assign_line_40_exit = 0;
__top->init._assign_line_41_exit = 0;
__top->init._if_line_10309976_exit = 0;
...
if ( !__top->p1.reader._call_line_53_called_fn_struct->Fetch_entry && !__top->p1.reader._call_line_53_called_fn_struct->Fetch_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
...
if ( __top->p1.reader._call_line_53_called_fn_struct->Fetch_entry || __top->p1.reader._call_line_53_called_fn_struct->Fetch_in_progress)  {// called function still in progress
// call the function
Fetch(
&(__top->p1.reader._call_line_53_called_fn_struct->req)
); //   file CacheMemory.aa, line 53
...
__top->p1.reader._call_line_55_called_fn_struct = (Is_Read_Access_State*) calloc(1,sizeof(Is_Read_Access_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.reader._call_line_55_called_fn_struct->Is_Read_Access_entry && !__top->p1.reader._call_line_55_called_fn_struct->Is_Read_Access_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
...
if ( __top->p1.reader._call_line_55_called_fn_struct->Is_Read_Access_entry || __top->p1.reader._call_line_55_called_fn_struct->Is_Read_Access_in_progress)  {// called function still in progress
// call the function
Is_Read_Access(
__top->p1.reader._call_line_55_called_fn_struct->req,
&(__top->p1.reader._call_line_55_called_fn_struct->flag)
); //   file CacheMemory.aa, line 55
...
__top->p1.reader._call_line_57_called_fn_struct = (Access_Address_State*) calloc(1,sizeof(Access_Address_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.reader._call_line_57_called_fn_struct->Access_Address_entry && !__top->p1.reader._call_line_57_called_fn_struct->Access_Address_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
...
if ( __top->p1.reader._call_line_57_called_fn_struct->Access_Address_entry || __top->p1.reader._call_line_57_called_fn_struct->Access_Address_in_progress)  {// called function still in progress
// call the function
Access_Address(
__top->p1.reader._call_line_57_called_fn_struct->req,
&(__top->p1.reader._call_line_57_called_fn_struct->addr)
); //   file CacheMemory.aa, line 57
...
__top->p1.reader.extwrite._call_line_60_called_fn_struct = (Access_Address_State*) calloc(1,sizeof(Access_Address_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.reader.extwrite._call_line_60_called_fn_struct->Access_Address_entry && !__top->p1.reader.extwrite._call_line_60_called_fn_struct->Access_Address_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->p1.reader.extwrite._call_line_60_called_fn_struct->req.__val = (__top->p1.reader.req_pointer).__val;
__top->p1.reader.extwrite._call_line_60_called_fn_struct->Access_Address_entry = 1;
} // arguments copied to call structure
} // called function had entry flag set
if ( __top->p1.reader.extwrite._call_line_60_called_fn_struct->Access_Address_entry || __top->p1.reader.extwrite._call_line_60_called_fn_struct->Access_Address_in_progress)  {// called function still in progress
// call the function
Access_Address(
__top->p1.reader.extwrite._call_line_60_called_fn_struct->req,
&(__top->p1.reader.extwrite._call_line_60_called_fn_struct->addr)
); //   file CacheMemory.aa, line 60
...
(__top->write_address_pipe).__val = __top->p1.reader.extwrite._call_line_60_called_fn_struct->addr.__val;
...
__top->p1.reader.extwrite._call_line_61_called_fn_struct = (Access_Data_State*) calloc(1,sizeof(Access_Data_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.reader.extwrite._call_line_61_called_fn_struct->Access_Data_entry && !__top->p1.reader.extwrite._call_line_61_called_fn_struct->Access_Data_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->p1.reader.extwrite._call_line_61_called_fn_struct->req.__val = (__top->p1.reader.req_pointer).__val;
__top->p1.reader.extwrite._call_line_61_called_fn_struct->Access_Data_entry = 1;
} // arguments copied to call structure
} // called function had entry flag set
if ( __top->p1.reader.extwrite._call_line_61_called_fn_struct->Access_Data_entry || __top->p1.reader.extwrite._call_line_61_called_fn_struct->Access_Data_in_progress)  {// called function still in progress
// call the function
Access_Data(
__top->p1.reader.extwrite._call_line_61_called_fn_struct->req,
&(__top->p1.reader.extwrite._call_line_61_called_fn_struct->data)
); //   file CacheMemory.aa, line 61
...
(__top->write_data_pipe).__val = __top->p1.reader.extwrite._call_line_61_called_fn_struct->data.__val;
...
// -------------------------------------------------------------------------------------------
			if ((1 && __top->p1.writeport.getdetails._assign_line_74_exit && __top->p1.writeport.getdetails._assign_line_73_exit)) {
...
{
if (1) {
if (__EQUAL((__top->addr_array[(__top->p1.writeport.addr).__val]).__val, (__top->p1.writeport.write_address).__val)) { 
...
__top->p1.writeport._call_line_81_called_fn_struct = (Write_Hit_State*) calloc(1,sizeof(Write_Hit_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.writeport._call_line_81_called_fn_struct->Write_Hit_entry && !__top->p1.writeport._call_line_81_called_fn_struct->Write_Hit_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->p1.writeport._call_line_81_called_fn_struct->addr.__val = (__top->p1.writeport.write_address).__val;
__top->p1.writeport._call_line_81_called_fn_struct->Write_Hit_entry = 1;
} // arguments copied to call structure
} // called function had entry flag set
if ( __top->p1.writeport._call_line_81_called_fn_struct->Write_Hit_entry || __top->p1.writeport._call_line_81_called_fn_struct->Write_Hit_in_progress)  {// called function still in progress
// call the function
Write_Hit(
__top->p1.writeport._call_line_81_called_fn_struct->addr
); //   file CacheMemory.aa, line 81
...
__top->p1.writeport._call_line_84_called_fn_struct = (Write_Miss_State*) calloc(1,sizeof(Write_Miss_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.writeport._call_line_84_called_fn_struct->Write_Miss_entry && !__top->p1.writeport._call_line_84_called_fn_struct->Write_Miss_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->p1.writeport._call_line_84_called_fn_struct->addr.__val = (__top->p1.writeport.write_address).__val;
__top->p1.writeport._call_line_84_called_fn_struct->Write_Miss_entry = 1;
} // arguments copied to call structure
} // called function had entry flag set
if ( __top->p1.writeport._call_line_84_called_fn_struct->Write_Miss_entry || __top->p1.writeport._call_line_84_called_fn_struct->Write_Miss_in_progress)  {// called function still in progress
// call the function
Write_Miss(
__top->p1.writeport._call_line_84_called_fn_struct->addr
); //   file CacheMemory.aa, line 84
...
__top->p1.writeport._call_line_91_called_fn_struct = (Write_Hit_State*) calloc(1,sizeof(Write_Hit_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.writeport._call_line_91_called_fn_struct->Write_Hit_entry && !__top->p1.writeport._call_line_91_called_fn_struct->Write_Hit_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->p1.writeport._call_line_91_called_fn_struct->addr.__val = (__top->p1.writeport.write_address).__val;
__top->p1.writeport._call_line_91_called_fn_struct->Write_Hit_entry = 1;
} // arguments copied to call structure
} // called function had entry flag set
if ( __top->p1.writeport._call_line_91_called_fn_struct->Write_Hit_entry || __top->p1.writeport._call_line_91_called_fn_struct->Write_Hit_in_progress)  {// called function still in progress
// call the function
Write_Hit(
__top->p1.writeport._call_line_91_called_fn_struct->addr
); //   file CacheMemory.aa, line 91
...
{
if (1) {
if (__EQUAL((__top->addr_array[(__top->p1.readport.addr).__val]).__val, (__top->p1.readport.read_address).__val)) { 
...
__top->p1.readport._call_line_105_called_fn_struct = (Read_Hit_State*) calloc(1,sizeof(Read_Hit_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.readport._call_line_105_called_fn_struct->Read_Hit_entry && !__top->p1.readport._call_line_105_called_fn_struct->Read_Hit_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->p1.readport._call_line_105_called_fn_struct->addr.__val = (__top->p1.readport.read_address).__val;
__top->p1.readport._call_line_105_called_fn_struct->data.__val = (__top->data_array[(__top->p1.readport.addr).__val]).__val;
__top->p1.readport._call_line_105_called_fn_struct->Read_Hit_entry = 1;
} // arguments copied to call structure
} // called function had entry flag set
if ( __top->p1.readport._call_line_105_called_fn_struct->Read_Hit_entry || __top->p1.readport._call_line_105_called_fn_struct->Read_Hit_in_progress)  {// called function still in progress
// call the function
Read_Hit(
__top->p1.readport._call_line_105_called_fn_struct->addr,
__top->p1.readport._call_line_105_called_fn_struct->data
); //   file CacheMemory.aa, line 105
...
__top->p1.readport._call_line_108_called_fn_struct = (Read_Miss_State*) calloc(1,sizeof(Read_Miss_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.readport._call_line_108_called_fn_struct->Read_Miss_entry && !__top->p1.readport._call_line_108_called_fn_struct->Read_Miss_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->p1.readport._call_line_108_called_fn_struct->addr.__val = (__top->p1.readport.read_address).__val;
__top->p1.readport._call_line_108_called_fn_struct->Read_Miss_entry = 1;
} // arguments copied to call structure
} // called function had entry flag set
if ( __top->p1.readport._call_line_108_called_fn_struct->Read_Miss_entry || __top->p1.readport._call_line_108_called_fn_struct->Read_Miss_in_progress)  {// called function still in progress
// call the function
Read_Miss(
__top->p1.readport._call_line_108_called_fn_struct->addr
); //   file CacheMemory.aa, line 108
...
__top->p1.readport._call_line_112_called_fn_struct = (Read_Miss_State*) calloc(1,sizeof(Read_Miss_State));
// reset entry flag and set in progress flag
...
if ( !__top->p1.readport._call_line_112_called_fn_struct->Read_Miss_entry && !__top->p1.readport._call_line_112_called_fn_struct->Read_Miss_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->p1.readport._call_line_112_called_fn_struct->addr.__val = (__top->p1.readport.read_address).__val;
__top->p1.readport._call_line_112_called_fn_struct->Read_Miss_entry = 1;
} // arguments copied to call structure
} // called function had entry flag set
if ( __top->p1.readport._call_line_112_called_fn_struct->Read_Miss_entry || __top->p1.readport._call_line_112_called_fn_struct->Read_Miss_in_progress)  {// called function still in progress
// call the function
Read_Miss(
__top->p1.readport._call_line_112_called_fn_struct->addr
); //   file CacheMemory.aa, line 112
