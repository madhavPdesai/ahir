...
cachememory ()
{
  cachememory_State *__top =
    (cachememory_State *) calloc (1, sizeof (cachememory_State));
...
// -------------------------------------------------------------------------------------------
	      if (__top->p1.reader._call_line_53_entry)
		{
		  if (__top->p1.reader._call_line_53_called_fn_struct == NULL)
		    {
		      __top->p1.reader._call_line_53_called_fn_struct =
			(Fetch_State *) calloc (1, sizeof (Fetch_State));
// reset entry flag and set in progress flag
		...
		{
		  if (!__top->p1.reader._call_line_53_called_fn_struct->
		      Fetch_entry
		      && !__top->p1.reader._call_line_53_called_fn_struct->
		      Fetch_in_progress)
		  ...
		  if (__top->p1.reader._call_line_53_called_fn_struct->
		      ...
		      if (1)
			{
			  ...
			  cfree (__top->p1.reader.
				 _call_line_53_called_fn_struct);
			  __top->p1.reader._call_line_53_called_fn_struct =
			    NULL;
...
// reset entry flag and set in progress flag
		...
		{
		  if (!__top->p1.reader._call_line_55_called_fn_struct->
		      Is_Read_Access_entry
		      && !__top->p1.reader._call_line_55_called_fn_struct->
		      Is_Read_Access_in_progress)
		    {		// entry and in_progress flags not set?
		      if (1)
			{	// check if pipes can be read from
			  __top->p1.reader._call_line_55_called_fn_struct->
			    req.__val = (__top->p1.reader.req_pointer).__val;
			  __top->p1.reader._call_line_55_called_fn_struct->
			    Is_Read_Access_entry = 1;
			}	// arguments copied to call structure
		    }		// called function had entry flag set
		  if (__top->p1.reader._call_line_55_called_fn_struct->
		      Is_Read_Access_entry
...
// call the function
		      ...
		      __top->p1.reader._call_line_55_called_fn_struct->
			Is_Read_Access_entry = 0;
		      __top->p1.reader._call_line_55_called_fn_struct->
			Is_Read_Access_in_progress = 0;
		      __top->p1.reader._call_line_55_called_fn_struct->
			Is_Read_Access_exit = 1;
		    }		// called function was in progress 
		  if (__top->p1.reader._call_line_55_called_fn_struct->
		      Is_Read_Access_exit)
		    {
		      if (1)
			{
			  (__top->p1.reader.is_read).__val =
			    __top->p1.reader._call_line_55_called_fn_struct->
			    flag.__val;
			  cfree (__top->p1.reader.
				 _call_line_55_called_fn_struct);
			  __top->p1.reader._call_line_55_called_fn_struct =
			    NULL;
// reset in progress flag and set exit flag
...
// -------------------------------------------------------------------------------------------
		  if (__top->p1.reader._call_line_57_entry)
		    {
		      if (__top->p1.reader._call_line_57_called_fn_struct ==
			  NULL)
			{
			  __top->p1.reader._call_line_57_called_fn_struct =
			    (Access_Address_State *) calloc (1,
							     sizeof
...
// reset entry flag and set in progress flag
		  ...
		  if (__top->p1.reader._call_line_57_in_progress)
		    {
		      if (!__top->p1.reader._call_line_57_called_fn_struct->
			  Access_Address_entry
			  && !__top->p1.reader.
			  _call_line_57_called_fn_struct->
			  Access_Address_in_progress)
			{	// entry and in_progress flags not set?
			  if (1)
			    {	// check if pipes can be read from
			      __top->p1.reader.
				_call_line_57_called_fn_struct->req.__val =
				(__top->p1.reader.req_pointer).__val;
			      __top->p1.reader.
				_call_line_57_called_fn_struct->
				Access_Address_entry = 1;
			    }	// arguments copied to call structure
			}	// called function had entry flag set
		      if (__top->p1.reader._call_line_57_called_fn_struct->
			  Access_Address_entry
...
// call the function
			  ...
			  __top->p1.reader._call_line_57_called_fn_struct->
			    Access_Address_entry = 0;
			  __top->p1.reader._call_line_57_called_fn_struct->
			    Access_Address_in_progress = 0;
			  __top->p1.reader._call_line_57_called_fn_struct->
			    Access_Address_exit = 1;
			}	// called function was in progress 
		      if (__top->p1.reader._call_line_57_called_fn_struct->
			  Access_Address_exit)
			{
			  if (1 && !__top->read_address_pipe_valid__)
			    {
			      (__top->read_address_pipe).__val =
				__top->p1.reader.
				_call_line_57_called_fn_struct->addr.__val;
			      __top->read_address_pipe_valid__ = 1;
			      cfree (__top->p1.reader.
				     _call_line_57_called_fn_struct);
			      __top->p1.reader.
				_call_line_57_called_fn_struct = NULL;
// reset in progress flag and set exit flag
...
// -------------------------------------------------------------------------------------------
			...
			{
			  if (__top->p1.reader.extwrite.
			      _call_line_60_called_fn_struct == NULL)
			    {
			      __top->p1.reader.extwrite.
				_call_line_60_called_fn_struct =
				(Access_Address_State *) calloc (1,
								 sizeof
								 (Access_Address_State));
// reset entry flag and set in progress flag
			      __top->p1.reader.extwrite._call_line_60_entry =
				0;
			      __top->p1.reader.extwrite.
				_call_line_60_in_progress = 1;
			    }	// allocation of pointer to called function
			}	// entry into this call statement
		      if (__top->p1.reader.extwrite._call_line_60_in_progress)
			{
			  if (!__top->p1.reader.extwrite.
				...
				{	// check if pipes can be read from
				  __top->p1.reader.extwrite.
				    _call_line_60_called_fn_struct->req.
				    __val =
				    (__top->p1.reader.req_pointer).__val;
				  __top->p1.reader.extwrite.
				    _call_line_60_called_fn_struct->
			  ...
			  if (__top->p1.reader.extwrite.
			      ...
			      if (1 && !__top->write_address_pipe_valid__)
				{
				  (__top->write_address_pipe).__val =
				    __top->p1.reader.extwrite.
				    _call_line_60_called_fn_struct->addr.
				    __val;
				  __top->write_address_pipe_valid__ = 1;
				  cfree (__top->p1.reader.extwrite.
					 _call_line_60_called_fn_struct);
				  __top->p1.reader.extwrite.
				    _call_line_60_called_fn_struct = NULL;
// reset in progress flag and set exit flag
				  __top->p1.reader.extwrite.
				    _call_line_60_exit = 1;
				  __top->p1.reader.extwrite.
				    _call_line_60_in_progress = 0;
				}	// ok to copy outputs to destinations?
			    }	// called function had finishes?
			}	// statement was in progress
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
			...
			{
			  if (__top->p1.reader.extwrite.
			      _call_line_61_called_fn_struct == NULL)
			    {
			      __top->p1.reader.extwrite.
				_call_line_61_called_fn_struct =
				(Access_Data_State *) calloc (1,
							      sizeof
							      (Access_Data_State));
// reset entry flag and set in progress flag
			      __top->p1.reader.extwrite._call_line_61_entry =
				0;
			      __top->p1.reader.extwrite.
				_call_line_61_in_progress = 1;
			    }	// allocation of pointer to called function
			}	// entry into this call statement
		      if (__top->p1.reader.extwrite._call_line_61_in_progress)
			{
			  if (!__top->p1.reader.extwrite.
			      ...
			      && !__top->p1.reader.extwrite.
			      _call_line_61_called_fn_struct->
			      Access_Data_in_progress)
			    {	// entry and in_progress flags not set?
			      if (1)
				{	// check if pipes can be read from
				  __top->p1.reader.extwrite.
				    _call_line_61_called_fn_struct->req.
				    __val =
				    (__top->p1.reader.req_pointer).__val;
				  __top->p1.reader.extwrite.
				    _call_line_61_called_fn_struct->
			  ...
			  if (__top->p1.reader.extwrite.
			      ...
			      if (1 && !__top->write_data_pipe_valid__)
				{
				  (__top->write_data_pipe).__val =
				    __top->p1.reader.extwrite.
				    _call_line_61_called_fn_struct->data.
				    __val;
...
// reset in progress flag and set exit flag
				  __top->p1.reader.extwrite.
				    _call_line_61_exit = 1;
				  __top->p1.reader.extwrite.
				    _call_line_61_in_progress = 0;
				}	// ok to copy outputs to destinations?
			    }	// called function had finishes?
			}	// statement was in progress
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
		      if ((1 && __top->p1.reader.extwrite._call_line_61_exit
			   && __top->p1.reader.extwrite._call_line_60_exit))
			{
...
// -------------------------------------------------------------------------------------------
		  if (__top->p1.writeport.getdetails._assign_line_73_entry)
		      ...
		      if (1 && __top->write_address_pipe_valid__)
			{
			  ...
			  __top->p1.writeport.getdetails.
			    _assign_line_73_entry = 0;
			  __top->p1.writeport.getdetails.
			    _assign_line_73_exit = 1;
			}
		    }
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
		  if (__top->p1.writeport.getdetails._assign_line_74_entry)
		      ...
		      if (1 && __top->write_data_pipe_valid__)
			{
			  ...
			  __top->p1.writeport.getdetails.
			    _assign_line_74_entry = 0;
			  __top->p1.writeport.getdetails.
			    _assign_line_74_exit = 1;
			}
		    }
// -------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------
		  if ((1
		       && __top->p1.writeport.getdetails._assign_line_74_exit
		       && __top->p1.writeport.getdetails.
		       _assign_line_73_exit))
		    {
		      __top->p1.writeport.getdetails._assign_line_73_exit = 0;
		      __top->p1.writeport.getdetails._assign_line_74_exit = 0;
		      __top->p1.writeport.getdetails.getdetails_in_progress =
			0;
...
// -------------------------------------------------------------------------------------------
	      if (__top->p1.writeport._if_line_77_entry)
		{
		  if (1)
		    {
		      if ((__top->
			   valid_array[(__top->p1.writeport.addr).__val]).
			  __val)
			{
...
// -------------------------------------------------------------------------------------------
		  if (__top->p1.writeport._if_line_78_entry)
		      ...
		      if (1)
			{
			  if (__EQUAL
			      ((__top->
				addr_array[(__top->p1.writeport.addr).__val]).
			       __val,
...
// -------------------------------------------------------------------------------------------
			...
			{
			  if (__top->p1.writeport.
			      _call_line_81_called_fn_struct == NULL)
			    {
			      __top->p1.writeport.
				_call_line_81_called_fn_struct =
				(Write_Hit_State *) calloc (1,
							    sizeof
							    (Write_Hit_State));
// reset entry flag and set in progress flag
			      __top->p1.writeport._call_line_81_entry = 0;
			      __top->p1.writeport._call_line_81_in_progress =
				1;
			    }	// allocation of pointer to called function
			}	// entry into this call statement
			...
			{
			  if (!__top->p1.writeport.
			      _call_line_81_called_fn_struct->Write_Hit_entry
			      && !__top->p1.writeport.
			      _call_line_81_called_fn_struct->
			      Write_Hit_in_progress)
			    {	// entry and in_progress flags not set?
			      if (1)
				{	// check if pipes can be read from
				  __top->p1.writeport.
				    _call_line_81_called_fn_struct->addr.
				    __val =
				    (__top->p1.writeport.write_address).__val;
				  __top->p1.writeport.
				    _call_line_81_called_fn_struct->
...
// call the function
				...
				Write_Hit_entry = 0;
			      __top->p1.writeport.
				_call_line_81_called_fn_struct->
				Write_Hit_in_progress = 0;
			      __top->p1.writeport.
				_call_line_81_called_fn_struct->
				Write_Hit_exit = 1;
			    }	// called function was in progress 
			  if (__top->p1.writeport.
			      _call_line_81_called_fn_struct->Write_Hit_exit)
			    {
			      if (1)
				{
				  cfree (__top->p1.writeport.
					 _call_line_81_called_fn_struct);
				  __top->p1.writeport.
				    _call_line_81_called_fn_struct = NULL;
// reset in progress flag and set exit flag
...
// -------------------------------------------------------------------------------------------
			...
			{
			  if (__top->p1.writeport.
			      _call_line_84_called_fn_struct == NULL)
			    {
			      __top->p1.writeport.
				_call_line_84_called_fn_struct =
				(Write_Miss_State *) calloc (1,
							     sizeof
							     (Write_Miss_State));
// reset entry flag and set in progress flag
			      __top->p1.writeport._call_line_84_entry = 0;
			      __top->p1.writeport._call_line_84_in_progress =
				1;
			    }	// allocation of pointer to called function
			}	// entry into this call statement
			...
			{
			  if (!__top->p1.writeport.
			      _call_line_84_called_fn_struct->Write_Miss_entry
			      && !__top->p1.writeport.
			      _call_line_84_called_fn_struct->
			      Write_Miss_in_progress)
			    {	// entry and in_progress flags not set?
			      if (1)
				{	// check if pipes can be read from
				  __top->p1.writeport.
				    _call_line_84_called_fn_struct->addr.
				    __val =
				    (__top->p1.writeport.write_address).__val;
				  __top->p1.writeport.
				    _call_line_84_called_fn_struct->
...
// call the function
				...
				Write_Miss_entry = 0;
			      __top->p1.writeport.
				_call_line_84_called_fn_struct->
				Write_Miss_in_progress = 0;
			      __top->p1.writeport.
				_call_line_84_called_fn_struct->
				Write_Miss_exit = 1;
			    }	// called function was in progress 
			  if (__top->p1.writeport.
			      _call_line_84_called_fn_struct->Write_Miss_exit)
			    {
			      if (1)
				{
				  cfree (__top->p1.writeport.
...
// -------------------------------------------------------------------------------------------
		  if (__top->p1.writeport._call_line_91_entry)
		    {
		      if (__top->p1.writeport.
			  _call_line_91_called_fn_struct == NULL)
			{
...
// reset entry flag and set in progress flag
		  ...
		  if (__top->p1.writeport._call_line_91_in_progress)
		    {
		      if (!__top->p1.writeport.
			  _call_line_91_called_fn_struct->Write_Hit_entry
			  && !__top->p1.writeport.
			  _call_line_91_called_fn_struct->
			  Write_Hit_in_progress)
			{	// entry and in_progress flags not set?
			  if (1)
			    {	// check if pipes can be read from
			      __top->p1.writeport.
				_call_line_91_called_fn_struct->addr.__val =
				(__top->p1.writeport.write_address).__val;
			      __top->p1.writeport.
				_call_line_91_called_fn_struct->
				Write_Hit_entry = 1;
		      ...
		      if (__top->p1.writeport._call_line_91_called_fn_struct->
			  Write_Hit_entry
			  || __top->p1.writeport.
			  _call_line_91_called_fn_struct->
			  Write_Hit_in_progress)
...
// reset in progress flag and set exit flag
			      ...
			      __top->p1.writeport._call_line_91_in_progress =
				0;
			    }	// ok to copy outputs to destinations?
			}	// called function had finishes?
		    }		// statement was in progress
...
// -------------------------------------------------------------------------------------------
	      if (__top->p1.readport._if_line_102_entry)
		{
		  if (1)
		    {
		      if ((__top->
			   valid_array[(__top->p1.readport.addr).__val]).
			  __val)
			{
...
// -------------------------------------------------------------------------------------------
		  if (__top->p1.readport._if_line_103_entry)
		      ...
		      if (1)
			{
			  if (__EQUAL
			      ((__top->
				addr_array[(__top->p1.readport.addr).__val]).
			       __val,
...
// -------------------------------------------------------------------------------------------
			...
			{
			  if (__top->p1.readport.
			      _call_line_105_called_fn_struct == NULL)
			    {
			      __top->p1.readport.
				_call_line_105_called_fn_struct =
				(Read_Hit_State *) calloc (1,
							   sizeof
							   (Read_Hit_State));
// reset entry flag and set in progress flag
			      __top->p1.readport._call_line_105_entry = 0;
			      __top->p1.readport._call_line_105_in_progress =
				1;
			    }	// allocation of pointer to called function
			}	// entry into this call statement
			...
			{
			  if (!__top->p1.readport.
			      _call_line_105_called_fn_struct->Read_Hit_entry
			      && !__top->p1.readport.
			      _call_line_105_called_fn_struct->
			      Read_Hit_in_progress)
			    {	// entry and in_progress flags not set?
			      if (1)
				{	// check if pipes can be read from
				  __top->p1.readport.
				    _call_line_105_called_fn_struct->addr.
				    __val =
				    (__top->p1.readport.read_address).__val;
				  __top->p1.readport.
				    _call_line_105_called_fn_struct->data.
				    __val =
				    (__top->
				     data_array[(__top->p1.readport.addr).
						__val]).__val;
				  __top->p1.readport.
				    _call_line_105_called_fn_struct->
				    Read_Hit_entry = 1;
...
// call the function
				...
				Read_Hit_entry = 0;
			      __top->p1.readport.
				_call_line_105_called_fn_struct->
				Read_Hit_in_progress = 0;
			      __top->p1.readport.
				_call_line_105_called_fn_struct->
				Read_Hit_exit = 1;
			    }	// called function was in progress 
			  if (__top->p1.readport.
			      _call_line_105_called_fn_struct->Read_Hit_exit)
			    {
			      if (1)
				{
				  cfree (__top->p1.readport.
					 _call_line_105_called_fn_struct);
				  __top->p1.readport.
				    _call_line_105_called_fn_struct = NULL;
// reset in progress flag and set exit flag
...
// -------------------------------------------------------------------------------------------
			...
			{
			  if (__top->p1.readport.
			      _call_line_108_called_fn_struct == NULL)
			    {
			      __top->p1.readport.
				_call_line_108_called_fn_struct =
				(Read_Miss_State *) calloc (1,
							    sizeof
							    (Read_Miss_State));
// reset entry flag and set in progress flag
			      __top->p1.readport._call_line_108_entry = 0;
			      __top->p1.readport._call_line_108_in_progress =
				1;
			    }	// allocation of pointer to called function
			}	// entry into this call statement
			...
			{
			  if (!__top->p1.readport.
			      _call_line_108_called_fn_struct->Read_Miss_entry
			      && !__top->p1.readport.
			      _call_line_108_called_fn_struct->
			      Read_Miss_in_progress)
			    {	// entry and in_progress flags not set?
			      if (1)
				{	// check if pipes can be read from
				  __top->p1.readport.
				    _call_line_108_called_fn_struct->addr.
				    __val =
				    (__top->p1.readport.read_address).__val;
				  __top->p1.readport.
				    _call_line_108_called_fn_struct->
...
// call the function
				...
				Read_Miss_entry = 0;
			      __top->p1.readport.
				_call_line_108_called_fn_struct->
				Read_Miss_in_progress = 0;
			      __top->p1.readport.
				_call_line_108_called_fn_struct->
				Read_Miss_exit = 1;
			    }	// called function was in progress 
			  if (__top->p1.readport.
			      _call_line_108_called_fn_struct->Read_Miss_exit)
			    {
			      if (1)
				{
				  cfree (__top->p1.readport.
...
// -------------------------------------------------------------------------------------------
		  if (__top->p1.readport._call_line_112_entry)
		    {
		      if (__top->p1.readport.
			  _call_line_112_called_fn_struct == NULL)
			{
...
// reset entry flag and set in progress flag
		  ...
		  if (__top->p1.readport._call_line_112_in_progress)
		    {
		      if (!__top->p1.readport.
			  _call_line_112_called_fn_struct->Read_Miss_entry
			  && !__top->p1.readport.
			  _call_line_112_called_fn_struct->
			  Read_Miss_in_progress)
			{	// entry and in_progress flags not set?
			  if (1)
			    {	// check if pipes can be read from
			      __top->p1.readport.
				_call_line_112_called_fn_struct->addr.__val =
				(__top->p1.readport.read_address).__val;
			      __top->p1.readport.
				_call_line_112_called_fn_struct->
				Read_Miss_entry = 1;
		      ...
		      if (__top->p1.readport._call_line_112_called_fn_struct->
			  Read_Miss_entry
			  || __top->p1.readport.
			  _call_line_112_called_fn_struct->
			  Read_Miss_in_progress)
...
// reset in progress flag and set exit flag
			      ...
			      __top->p1.readport._call_line_112_in_progress =
				0;
			    }	// ok to copy outputs to destinations?
			}	// called function had finishes?
		    }		// statement was in progress
...
// End Block readport
// -------------------------------------------------------------------------------------------
	  if ((1 && __top->p1.readport.readport_exit
	       && __top->p1.writeport.writeport_exit
	       && __top->p1.reader.reader_exit))
	    {
