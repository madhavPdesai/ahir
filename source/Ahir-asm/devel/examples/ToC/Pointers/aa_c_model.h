...
typedef struct passpointer_State__
{
  ...
  uint_32 q;
  unsigned int _call_line_25_entry:1;
  unsigned int _call_line_25_in_progress:1;
  unsigned int _call_line_25_exit:1;
  increment_State *_call_line_25_called_fn_struct;
