...
typedef struct passpointer_State__
{
  ...
  uint_32 q;
  unsigned int _call_line_29_entry:1;
  unsigned int _call_line_29_in_progress:1;
  unsigned int _call_line_29_exit:1;
  increment_State *_call_line_29_called_fn_struct;
