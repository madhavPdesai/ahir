...
uint_32 u;
uint_32 v;
int increment(uint_32 incr_a, uint_32*  incr_b)
{
increment_State* __top = (increment_State*) calloc(1,sizeof(increment_State));
...
increment_State* increment_(increment_State* __top)
{
...
__top->_call_line_29_called_fn_struct = (increment_State*) calloc(1,sizeof(increment_State));
...
if ( !__top->_call_line_29_called_fn_struct->increment_entry && !__top->_call_line_29_called_fn_struct->increment_in_progress) {// entry and in_progress flags not set?
if (1) { // check if pipes can be read from
__top->_call_line_29_called_fn_struct->incr_a.__val = (__top->q).__val;
...
if ( __top->_call_line_29_called_fn_struct->increment_entry || __top->_call_line_29_called_fn_struct->increment_in_progress)  {// called function still in progress
// call the function
...
if (1) {
(__top->b).__val = __top->_call_line_29_called_fn_struct->incr_b.__val;
