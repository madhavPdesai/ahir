...
The type of the inputs and the output is \$uint<32>
...
$float<11,52> 
\end{verbatim}
respectively.  Currently, \$float<8,23> 
and \$float<11,42> are the
...
\section{Pointer de-reference expressions}
...
\section{Address-of expressions}
